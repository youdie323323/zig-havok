...
```pwsh
./wamrc.exe --target=x86_64 --cpu=x86-64-v3 --opt-level=3 --size-level=0 --enable-simd --use-prof-file=HavokPhysics.profdata --format=aot -o x86_64\HavokPhysicsPGO.aot HavokPhysics.wasm
```